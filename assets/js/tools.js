...
var TOOLS = [
    { name: 'Signal', desc: 'End-to-end encrypted messaging. Gold standard for private communication.', url: 'https://signal.org', category: 'Messaging', openSource: true, free: true, difficulty: 1 },
    { name: 'ProtonMail', desc: 'Encrypted email service based in Switzerland. E2E by default.', url: 'https://proton.me/mail', category: 'Email', openSource: true, free: true, difficulty: 1 },
    { name: 'Proton Drive', desc: 'End-to-end encrypted cloud storage. Zero-knowledge.', url: 'https://proton.me/drive', category: 'Cloud Storage', openSource: true, free: true, difficulty: 1 },
    { name: 'Mullvad VPN', desc: 'Privacy-first VPN fixed monthly price no email required.', url: 'https://mullvad.net', category: 'VPN', openSource: true, free: false, difficulty: 2 },
    ...
    { name: 'Bitwarden', desc: 'Open source password manager with self-hosting option.', url: 'https://bitwarden.com', category: 'Password Managers', openSource: true, free: true, difficulty: 1 },
    { name: 'KeePassXC', desc: 'Offline password manager. Fully open source local storage.', url: 'https://keepassxc.org', category: 'Password Managers', openSource: true, free: true, difficulty: 2 },
    { name: 'KeePassDX', desc: 'Android password manager for KeePass databases. Open source.', url: 'https://keepassdx.com', category: 'Password Managers', openSource: true, free: true, difficulty: 2 },
    { name: 'Aegis Authenticator', desc: 'Free open source 2FA for Android. Secure encrypted.', url: 'https://getaegis.app', category: 'Two-Factor Authentication', openSource: true, free: true, difficulty: 1 },
    { name: 'Tor Browser', desc: 'Browse anonymously through the Tor network.', url: 'https://torproject.org', category: 'Browsers', openSource: true, free: true, difficulty: 2 },
    { name: 'Firefox', desc: 'Privacy-focused browser from Mozilla. Open source extensible.', url: 'https://firefox.com', category: 'Browsers', openSource: true, free: true, difficulty: 1 },
    { name: 'Brave', desc: 'Privacy-first browser with built-in ad blocking and Tor.', url: 'https://brave.com', category: 'Browsers', openSource: true, free: true, difficulty: 1 },
    { name: 'Mullvad Browser', desc: 'Privacy browser based on Firefox with anti-fingerprinting.', url: 'https://mullvad.net/browser', category: 'Browsers', openSource: true, free: true, difficulty: 1 },
    ...
    { name: 'Quad9', desc: 'Free DNS blocking malicious domains. No logging.', url: 'https://quad9.net', category: 'DNS', openSource: false, free: true, difficulty: 2 },
    { name: 'NextDNS', desc: 'Advanced DNS filtering with custom blocklists.', url: 'https://nextdns.io', category: 'DNS', openSource: false, free: true, difficulty: 2 },
    { name: 'Ubuntu', desc: 'Linux distro for beginners. Massive community.', url: 'https://ubuntu.com', category: 'Linux', openSource: true, free: true, difficulty: 2 },
    ...
    { name: 'F-Droid', desc: 'Open source Android app store. FOSS apps no tracking.', url: 'https://f-droid.org', category: 'Operating Systems', openSource: true, free: true, difficulty: 1 },
    ...
    { name: 'Syncthing', desc: 'Continuous file sync between your devices.', url: 'https://syncthing.net', category: 'Self-Hosting', openSource: true, free: true, difficulty: 3 },
    ...
    { name: 'WireGuard', desc: 'Modern fast secure VPN protocol.', url: 'https://wireguard.com', category: 'Networking', openSource: true, free: true, difficulty: 3 },
    ...
    { name: 'Ollama', desc: 'Run LLMs locally. Privacy-first AI no cloud.', url: 'https://ollama.ai', category: 'Artificial Intelligence', openSource: true, free: true, difficulty: 3 },
    ...
    { name: 'YubiKey', desc: 'Hardware security key. Strongest 2FA.', url: 'https://yubico.com', category: 'Security', openSource: false, free: false, difficulty: 2 },
    ...
    { name: 'Jellyfin', desc: 'Free open source media server. Plex alternative.', url: 'https://jellyfin.org', category: 'Self-Hosting', openSource: true, free: true, difficulty: 3 },
    ...
    { name: 'VSCodium', desc: 'Free open source code editor. No telemetry.', url: 'https://vscodium.com', category: 'Development', openSource: true, free: true, difficulty: 2 },
    { name: 'LibreOffice', desc: 'Free open source office suite. MS Office compatible.', url: 'https://libreoffice.org', category: 'Productivity', openSource: true, free: true, difficulty: 2 },
    { name: 'Thunderbird', desc: 'Open source email client with built-in encryption.', url: 'https://thunderbird.net', category: 'Email', openSource: true, free: true, difficulty: 2 },
    { name: 'K-9 Mail', desc: 'Android email client. Open source PGP support.', url: 'https://k9mail.app', category: 'Email', openSource: true, free: true, difficulty: 2 },
    { name: 'FairEmail', desc: 'Privacy-oriented Android email. Fully open source.', url: 'https://email.faircode.eu', category: 'Email', openSource: true, free: true, difficulty: 2 },
    ...
    { name: 'VLC Media Player', desc: 'Plays everything. Open source no ads.', url: 'https://videolan.org', category: 'Productivity', openSource: true, free: true, difficulty: 1 },
    { name: 'Audacity', desc: 'Free audio editor. Open source cross-platform.', url: 'https://audacityteam.org', category: 'Development', openSource: true, free: true, difficulty: 3 },
    { name: 'Penpot', desc: 'Free open source design platform. Figma alternative.', url: 'https://penpot.app', category: 'Development', openSource: true, free: true, difficulty: 3 },
    ...
    { name: 'OpenWrt', desc: 'Open source router OS. Full network control.', url: 'https://openwrt.org', category: 'Networking', openSource: true, free: true, difficulty: 4 },
    { name: 'Element', desc: 'Decentralized chat for Matrix protocol.', url: 'https://element.io', category: 'Messaging', openSource: true, free: true, difficulty: 2 },
