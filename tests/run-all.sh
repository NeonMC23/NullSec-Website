...
echo "== 42. Milestone 52 frontend architecture & CSS hygiene =="
node tests/m52-frontend-tests.mjs

echo "== 43. Milestone 53 performance & loading UX =="
node tests/m53-frontend-tests.mjs
...
echo "== 46. Milestone 56 feature integrity & wiring =="
node tests/m56-frontend-tests.mjs
...
echo "== 49. Milestone 59 visual consistency & responsive polish =="
node tests/m59-frontend-tests.mjs
